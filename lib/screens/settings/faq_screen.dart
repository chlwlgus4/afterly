      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFaqItem(
            ...
            answer:
                '모든 사진은 Firebase Storage에 안전하게 암호화되어 저장됩니다. '
          ...
          _buildFaqItem(
            ...
            answer:
                '고객 정보는 본인의 계정에만 저장되며, 다른 사용자나 제3자와 공유되지 않습니다. '
          ...
          _buildFaqItem(
            ...
            answer:
                '촬영 기록을 삭제하면 해당 Before/After 사진과 분석 데이터가 '
          ...
          _buildFaqItem(
            ...
            answer:
                '피부 분석은 이미지 처리 기술을 사용한 참고용 정보입니다. '
          ...
          _buildFaqItem(
            ...
            answer:
                '동일한 계정으로 로그인하면 모든 기기에서 데이터를 동기화하여 볼 수 있습니다. '
          ...
          _buildFaqItem(
            ...
            answer:
                '촬영은 오프라인에서도 가능하지만, 사진 업로드와 동기화는 '
          ...
          _buildFaqItem(
            ...
            answer:
                '계정을 삭제하면 모든 고객 정보, 촬영 기록, 사진이 영구적으로 삭제됩니다. '
